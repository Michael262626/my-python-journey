...
from PhoneBook.PhoneBokkApp import add_contact, delete_contact, edit_contact, search_contact, display_contacts, check_errors
...
class Test(TestCase):
    ...
    def test_search_contact(self):
        ...
        self.assertEqual(search_contact("Michael"), "Name: Michael Number: 1234567890")
    ...
    def test_edit_contact(self):
        ...
        edit_contact("Michael", "09876543210")
        self.assertEqual(self.contacts, {
            "Michael": "09876543210",
            "Jane": "9876543210"
        })
